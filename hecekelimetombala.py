...
tombala=["el","le","ele","elle",
         ...
         "eh","he","ah","ha","ih","hi","oh","ho","uh","hu","üh","hü","öh","hö","ıh","hı","halı","hala","haber","horoz","hece","ihtiyar","sonbahar","ahtapot","Hilmi","ıhlamur","hediye","Ahmet","Muhammet","hasta",
         "ilkbahar","Mehmet","bahçe","halay","haydi","Hande","Handan","Hülya","hayır","Hasan","hamur","hekim","hırka","hamam","hortum","Seher","Harun","timsah","hastane","hikaye","hak","han","hem","hızlı","her",
         "hiç","huy","hap","hey","hindi","hür","şah","siyah","Hakan","heykel","iştah","Semih","Şahin","Hüseyin","tahta","Bahri","hareket","dahi","hamsi","Hilal","İhsan","külah","Mehtap","Reha","muhtar","sahne","Serhat",
         "şehir","saha","haziran","hazır","hazırlık","sahil","sabah","Hayriye","huzur","lahana","harita","hatıra","hesap","halsiz","hizmetçi","hata","Hayri","baharat","cumhuriyet","zahmet","helikopter","kütüphane",
         "taht","halk","Hatice","hazine","Hakkı","Huriye","Nihal","hüzünlü","Halit","Hale","hamak","kahvaltı","Salih","halka","ehliyet","Hamza","harika","hanım","hanımeli","hayat","Nuh","hemşire","his","huni","haylaz",
         "Emirhan","hakem","hakim","halat","Havva","Taha","sürahi","horon","anahtar","hurma",
         "ev","ve","av","va","iv","vi","ov","vo","uv","vu","üv","vü","öv","vö","ıv","vı","hava","vatan","vida","kova","yavaş","ayva","bavul","ödev","havlu","davranış","vitamin","kavanoz","nevresim","Vildan","vişne",
         "Levent","avukat","Vedat","yuva","ova","yavru","valiz","Vural","Veysel","manav","deve","tavşan","davet","Volkan","baklava","Sevil","kavun","Veli","ceviz","revani","kivi","Nevin","vazo","kovala","vücut","Sevda",
         "vitrin","tava","yuvarlan","voleybol","merdiven","civciv","güvercin","tavuk","kaval","davul","Cevdet","mavi","havuç","sivrisinek","meyve","lav","var","vur","sev","ver","alev","çivi","duvar","görev","hayvan",
         "pilav","tavan","vadi","vali","avcı","çuval","evet","kahve","savaş","vagon","vapur","villa","bedava","kahvaltı","konserve","lavabo","vasıta","bisküvi","çerçeve","eldiven","Hacivat","kavurma","lacivert","kıvırcık",
         "yuvarlak","tornavida","televizyon","vinç","Yavuz","kovan","Avni","kereviz","dev","kov","avuç","evli","vana","veda","veya","gövde","havuz","kavak","Sevgi","cevap","cetvel","avize","Pervin","Servet","Sevinç",
         "Sevim","Seval","Havva","Merve","Mevlüt","evcil","devlet",
         "eğ","ğe","ağ","ğa","iğ","ği","oğ","ğo","uğ","ğu","üğ","ğü","öğ","ğö","ığ","ğı","dağ","ağaç","boğa","düğüm","kağıt","öğle","yağmur","poğaça","öğretmen","kurbağa","öğrenci","yoğurt","yağ","doğa","sağır","eğil",
         "oğlan","oğlak","öğün","uğra","leğen","yeğen","tığ","kuğu","ağır","eğri","sağ","sağanak","soğuk","iğne","iğde","Tuğçe","soğan","doğra","sığ","boğaz","Çiğdem","değnek","değirmen","oğul","öğüt","sağlık","söğüt",
         "tuğla","bağ","bağla","Buğra","Çağlar","dağcı","eğik","sağlam","Uğur","Yiğit","doğru","ağabey","Keloğlan","mağara","papağan","ağustos","armağan","Doğuş","eğitim","öğlenci","örneğin","ağaçkakan","Oğuz","gökkuşağı",
         "zeytinyağı","çağ","Tuğba","çığ","yoğun","ağrı","ağız","doğu","bağış","yağış","sığır","buğday","eğlence","Doğan","düğün","mağaza","Aytuğ","Göktuğ",
         "ef","fe","af","fa","if","fi","of","fo","uf","fu","üf","fü","öf","fö","ıf","fı","raf","fay","fes","fil","fok","fan","far","fen","fiş","afet","çarşaf","defa","fare","fakir","fıkra","fidan","file","fon","füze","hafta",
         "kafes","lütfen","ofis","şifa","ufak","farklı","büfe","fön","defter","fener","fırın","fıstık","Şafak","gofret","kafa","köfte","öfke","Fazıl","şoför","Ufuk","Zafer","afacan","fasulye","fazla","hafıza","kadife",
         "kıyafet","telefon","alfabe","define","hafif","kadayıf","karanfil","feda","misafir","şeftali","zürafa","nefis","forma","mutfak","Ferit","Funda","Mustafa","fincan","Fatma","Feyza","Fikret","fındık","Faruk","fırlat",
         "flüt","fırça","fotoğraf","mikrofon","eşofman","aferin","Fahri","fabrika","fırtına","Furkan","sofra","yufka","futbol","tüfek","Elif","Yusuf","fıçı","şef","kefe","tef","küf","saf","afiş","fide","final","fiyat","nefes",
         "faraş","sıfır","sefer","fayda","Sefa","künefe","Fadime","Fatih","Fatoş","Ferdi","Feride","Fulya","fayans","safir","Fırat","film","fakat","Efe","Filiz","sınıf","Fuat","fayton","fena","efendi","çiftlik","fosfor",
         "ej","je","aj","ja","ij","ji","oj","jo","uj","ju","üj","jü","öj","jö","ıj","jı","jeton","baraj","garaj","jilet","ajan","pijama","enerji","abajur","Müjgan","judo","Jüpiter","Jale","Ajda","deterjan","viraj","jöle","plaj",
         "bej","Müjde","bandaj","Nejat","jandarma","mesaj","ruj","Jülide","Japonya","jel","imaj","jile","alerji","ejderha","röportaj","şarj","jokey","Tanju","Müjdat","ambalaj","kolej","ajanda","obje","hijyenik","makyaj",
         "oje","rejim","jelibon","pasaj","ajans","jant","avantaj","lojman","patinaj","buji","jimnastik","kaju","jaluzi","oksijen","teknoloji","montaj","jüri","jet","masaj","dijital","jambon","jeneratör","Jade"]
...
label=Label(text="1. - 2. - 3. - 4. - 5. GRUP (ELAKİN - OMUTÜY - ÖRIDSB - ZÇGŞCP - HVĞFJ) HECE/KELİME TOMBALASI PROGRAMI",fg="red",font=("TTKB DikTemel Abece" ,20))
label.place(relx = 0.02, rely = 0.0)
